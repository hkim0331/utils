#!/usr/bin/env bb
#_" -*- mode: clojure; -*-"
;;; This is not my script, but usefull.
;;; synopsys: List outdated maven dependencies
;;; original: https://github.com/babashka/babashka/blob/master/examples/outdated.clj
...
;; from https://github.com/babashka/babashka/blob/master/examples/outdated.clj
